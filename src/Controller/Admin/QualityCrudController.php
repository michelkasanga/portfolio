...
class QualityCrudController extends AbstractCrudController
{
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
                        ...
                        ->setPageTitle(Crud::PAGE_DETAIL,fn (Quality $header) => sprintf(' <b>%s</b>', $header->getName()))   
                        ->setPageTitle(Crud::PAGE_EDIT,fn (Quality $header) => sprintf(' Edit <b>%s</b>', $header->getName()))            
